...
public class IdentifierGroup
{
    ...
    {
        if (!IdentifierGroupValidationRules.IsValidIdentifierGroupId(id, nameof(id), out string error))
        {
            throw new ArgumentException(error);
        }
        else if (!IdentifierGroupValidationRules.IsValidName(name, nameof(id), out error))
        {
            throw new ArgumentException(error);
        }
